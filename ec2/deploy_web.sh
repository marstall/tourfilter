...
do
	...
	ssh -t ec2-user@$ip_address "source ~/.bash_profile;cd /tourfilter;git pull;git branch reflyer;git checkout -f $1;sudo bundle pack;crontab config/crontab.web;sudo apachectl restart;rm public/index.html"
