...
as-create-launch-config lc_tourfilter_$2 --image-id $1 --instance-type m1.small --key kp_tourfilter --group quick-start-1 --user-data-file=$TOURFILTER_HOME/ec2/user_data_file.sh
