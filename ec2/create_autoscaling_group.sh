echo "This will create the asg_tourfilter_$2 scaling group with $3 instances based on AMI $1"
echo "press <enter> to continue."
read line

production_tag=`cat $TOURFILTER_HOME/production_tag`
echo $production_tag
as-create-launch-config lc_tourfilter_$2 --image-id $1 --instance-type m1.small --key kp_tourfilter --group quick-start-1 --user-data-file="user_data_file.sh r1"
